...
class Config(object):
	API_ID = int(os.environ.get("API_ID", 27196978))
	API_HASH = os.environ.get("API_HASH", "96d4f4b442f99b8f448947da97e423d7")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","7172255329:AAEkWLn6TJfNUbkpL0BxYQZ9yG-gByUiSR0")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "stooretest2_bot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1002105440720))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "5456201550"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://ayushgupta74560:<0706Pz6zRISOiMtf>@cluster0.cabos9h.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002146782917")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002047858400")
	...
	LP_CHANNEL_USRNM = os.environ.get("techyvro")
	LPCH_ADMIN_USRMN = os.environ.get("techyvro")
